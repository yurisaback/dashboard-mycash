...
function DashboardPage() {
  return (
    <div className="flex min-h-screen w-full min-w-0 flex-1 flex-col bg-background-primary">
      ...
      <div className="flex flex-1 flex-col self-stretch w-full min-w-0 max-w-full overflow-x-hidden px-4 md:px-6 lg:px-8 pt-0 pb-0 box-border">
        ...
        <div className="mt-0 grid w-full min-w-0 max-w-full grid-cols-1 gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)] lg:items-stretch">
          ...
          <div className="flex min-h-0 w-full min-w-0 flex-col items-center self-stretch gap-6 lg:row-span-2">
            <section
              className="grid min-h-0 grid-cols-1 gap-6 md:grid-cols-3 w-full min-w-0"
              aria-label="Resumo financeiro"
            >
              <div className="min-w-0 overflow-hidden min-h-[180px] md:min-h-[160px]">
                <BalanceCard />
              </div>
              <div className="min-w-0 overflow-hidden min-h-[180px] md:min-h-[160px]">
                <IncomeCard />
            ...
            <section className="flex w-full min-w-0" aria-label="Despesas por categoria">
