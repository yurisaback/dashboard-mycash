import svgPaths from "./svg-ktrzjmn9hy";
...
function InfoUser() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[96px]" data-name="info-user">
      <Members />
      <NameEmail />
    </div>
  );
    ...
    <div className="absolute right-[-16px] size-[32px] top-[16px]" data-name="close-sidebar">
      <div className="absolute inset-[0_-12.5%_-25%_-12.5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
          <g filter="url(#filter0_d_1_4605)" id="close-sidebar">
            <rect fill="var(--fill-0, white)" height="32" rx="16" width="32" x="4" />
            <path d={svgPaths.p9668900} fill="var(--fill-0, #080B12)" id="icon" />
          </g>
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="40" id="filter0_d_1_4605" width="40" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1_4605" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_1_4605" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
export default function SideBar() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start justify-between p-[32px] relative size-full" data-name="side-bar">
      <LogoMenu />
      <InfoUser />
      <CloseSidebar />
    </div>
